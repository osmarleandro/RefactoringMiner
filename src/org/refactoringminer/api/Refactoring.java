...
public interface Refactoring extends Serializable, CodeRangeProvider {
	...
	default void addRelatedRefactoring(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		changeVariableTypeRefactoring.relatedRefactorings.add(this);
	}
}