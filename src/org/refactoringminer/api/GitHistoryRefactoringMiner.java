...
public interface GitHistoryRefactoringMiner {
	 ...
	 */
	void detectAll(Repository repository, String branch, RefactoringHandler_RENAMED handler) throws Exception;
	 ...
	 * @throws Exception propagated from JGit library.
	 */
	void detectBetweenTags(Repository repository, String startTag, String endTag, RefactoringHandler_RENAMED handler)
			throws Exception;
	 ...
	 * @throws Exception propagated from JGit library.
	 */
	void detectBetweenCommits(Repository repository, String startCommitId, String endCommitId, RefactoringHandler_RENAMED handler)
			throws Exception;
	 ...
	 * @throws Exception propagated from JGit library.
	 */
	void fetchAndDetectNew(Repository repository, RefactoringHandler_RENAMED handler) throws Exception;
	 ...
	 */
	void detectAtCommit(Repository repository, String commitId, RefactoringHandler_RENAMED handler);
	 ...
	 */
	void detectAtCommit(Repository repository, String commitId, RefactoringHandler_RENAMED handler, int timeout);
	 ...
	 * @param timeout A timeout, in seconds. When timeout is reached, the operation stops and returns no refactorings.
	 */
	void detectAtCommit(String gitURL, String commitId, RefactoringHandler_RENAMED handler, int timeout);
	 ...
	 */
	void detectAtPullRequest(String gitURL, int pullRequest, RefactoringHandler_RENAMED handler, int timeout) throws Exception;
	 ...
	 * @param handler A handler object that is responsible to process the detected refactorings. 
	 */
	Churn churnAtCommit(Repository repository, String commitId, RefactoringHandler_RENAMED handler);
