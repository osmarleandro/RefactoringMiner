...
public abstract class UMLAbstractClass {
	...
	public UMLOperation operationWithTheSameSignatureIgnoringChangedTypes(UMLOperation operation) {
		...
		for(UMLOperation originalOperation : operations) {
			...
			if(matchesOperation) {
				boolean originalOperationEmptyBody = originalOperation.operationBody == null || originalOperation.hasEmptyBody();
				boolean operationEmptyBody = operation.operationBody == null || operation.hasEmptyBody();
