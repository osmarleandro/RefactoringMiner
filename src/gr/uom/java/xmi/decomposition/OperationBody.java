...
public class OperationBody {
	...
	private void processStatement(CompilationUnit cu, String filePath, CompositeStatementObject parent, Statement statement) {
		if(statement instanceof Block) {
			...
			(child).setIndex(parent.statementList.size());
			parent.statementList.add(child);
			...
			for(CatchClause catchClause : catchClauses) {
				...
				(catchClauseStatementObject).setIndex(parent.statementList.size());
				parent.statementList.add(catchClauseStatementObject);
				(catchClauseStatementObject).setParent(parent);
			...
			if(finallyBlock != null) {
				...
				(finallyClauseStatementObject).setIndex(parent.statementList.size());
				parent.statementList.add(finallyClauseStatementObject);
				(finallyClauseStatementObject).setParent(parent);
