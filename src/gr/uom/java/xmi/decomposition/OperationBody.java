...
public class OperationBody {
	...
	private void processStatement(CompilationUnit cu, String filePath, CompositeStatementObject parent, Statement statement) {
		if(statement instanceof Block) {
			...
			child.addExpression_RENAMED(abstractExpression);
			...
			child.addExpression_RENAMED(variableDeclarationName);
			if(variableDeclaration.getInitializer() != null) {
				...
				child.addExpression_RENAMED(variableDeclarationInitializer);
			}
			...
			for(Expression resource : resources) {
				...
				child.addExpression_RENAMED(expression);
			}
			...
			for(CatchClause catchClause : catchClauses) {
				...
				catchClauseStatementObject.addExpression_RENAMED(variableDeclarationName);
				if(variableDeclaration.getInitializer() != null) {
					AbstractExpression variableDeclarationInitializer = new AbstractExpression(cu, filePath, variableDeclaration.getInitializer(), CodeElementType.VARIABLE_DECLARATION_INITIALIZER);
					catchClauseStatementObject.addExpression_RENAMED(variableDeclarationInitializer);
				}
