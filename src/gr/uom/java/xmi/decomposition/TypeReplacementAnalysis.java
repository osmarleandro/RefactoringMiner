...
public class TypeReplacementAnalysis {
	...
	private void findTypeChanges() {
		for(AbstractCodeMapping mapping : mappings) {
			...
			for(Replacement replacement : mapping.getReplacements())
				extracted(mapping, fragment1, fragment2, replacement);
	...
	private void extracted(AbstractCodeMapping mapping, AbstractCodeFragment fragment1, AbstractCodeFragment fragment2,
