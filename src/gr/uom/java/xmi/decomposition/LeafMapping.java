	...
	public int compareTo(LeafMapping o) {
		...
		if(distance1 != distance2) {
			...
			if(depthDiff1 != depthDiff2) {
				...
				int indexDiff1 = Math.abs(this.getFragment1().getIndex_RENAMED() - this.getFragment2().getIndex_RENAMED());
				int indexDiff2 = Math.abs(o.getFragment1().getIndex_RENAMED() - o.getFragment2().getIndex_RENAMED());
