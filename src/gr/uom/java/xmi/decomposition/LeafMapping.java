...
public class LeafMapping extends AbstractCodeMapping implements Comparable<LeafMapping> {
	...
	public int compareTo(LeafMapping o) {
		...
		if(distance1 != distance2) {
			if(this.getFragment1().isIdenticalWithExtractedVariable(this) && !o.getFragment1().isIdenticalWithExtractedVariable(this)) {
				return -1;
			}
			else if(!this.getFragment1().isIdenticalWithExtractedVariable(this) && o.getFragment1().isIdenticalWithExtractedVariable(this)) {
				return 1;
			}
