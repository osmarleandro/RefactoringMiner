...
public class LeafMapping extends AbstractCodeMapping implements Comparable<LeafMapping> {
	...
	private double parentEditDistance() {
		...
		while(parent1 != null && parent1.getLocationInfo().getCodeElementType_RENAMED().equals(CodeElementType.BLOCK)) {
			parent1 = parent1.getParent();
		}
		CompositeStatementObject parent2 = getFragment2().getParent();
		while(parent2 != null && parent2.getLocationInfo().getCodeElementType_RENAMED().equals(CodeElementType.BLOCK)) {
