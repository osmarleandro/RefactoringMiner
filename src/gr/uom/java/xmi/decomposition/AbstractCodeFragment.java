...
public abstract class AbstractCodeFragment implements LocationInfoProvider {
	...
	String preprocessInput1(UMLOperationBodyMapper umlOperationBodyMapper, AbstractCodeFragment leaf2) {
		return umlOperationBodyMapper.preprocessInput(this, leaf2);
	}
}
