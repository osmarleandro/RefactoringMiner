	...
	public OperationInvocation invocationCoveringEntireFragment() {
		...
		for(String methodInvocation : methodInvocationMap.keySet()) {
			...
			for(OperationInvocation invocation : invocations) {
				...
				else if(invocation.getLocationInfo().codeElementType.equals(CodeElementType.SUPER_CONSTRUCTOR_INVOCATION) ||
						invocation.getLocationInfo().codeElementType.equals(CodeElementType.CONSTRUCTOR_INVOCATION)) {
					invocation.coverage = StatementCoverageType.ONLY_CALL;
					return invocation;
				}
			}
