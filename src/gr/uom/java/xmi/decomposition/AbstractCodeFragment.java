...
public abstract class AbstractCodeFragment implements LocationInfoProvider {
	...
	protected boolean containsInitializerOfVariableDeclaration(Set<String> expressions) {
		...
		if(variableDeclarations.size() == 1 && variableDeclarations.get(0).getInitializer_RENAMED() != null) {
			String initializer = variableDeclarations.get(0).getInitializer_RENAMED().toString();
