...
public class ConsistentReplacementDetector {
	...
	private static <T extends Replacement_RENAMED> Set<T> inconsistentRenames(
	...
	public static <T extends Replacement_RENAMED> void updateRenames(
	...
	private static <T extends Replacement_RENAMED> Set<T> filter(Set<T> inconsistentRenames,
			Map<String, Set<String>> aliasedAttributesInOriginalClass,
			Map<String, Set<String>> aliasedAttributesInNextClass) {
