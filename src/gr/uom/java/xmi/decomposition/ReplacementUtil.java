...
public class ReplacementUtil {
	...
	public static String performReplacement(String completeString1, String completeString2, String subString1, String subString2) {	
		...
		if(!replacementOccurred && !UMLOperationBodyMapper_RENAMED.containsMethodSignatureOfAnonymousClass(completeString1) && !UMLOperationBodyMapper_RENAMED.containsMethodSignatureOfAnonymousClass(completeString2)) {
			for(String character : SPECIAL_CHARACTERS) {
