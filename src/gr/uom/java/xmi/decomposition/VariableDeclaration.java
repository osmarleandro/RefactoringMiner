...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(ChangeAttributeTypeRefactoring changeAttributeTypeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(changeAttributeTypeRefactoring.getChangedTypeAttribute().getLocationInfo().getFilePath(), changeAttributeTypeRefactoring.getClassNameAfter()));
		return pairs;
	}
}
