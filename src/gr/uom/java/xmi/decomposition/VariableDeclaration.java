...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public boolean allVariablesAreParameters(MergeVariableRefactoring mergeVariableRefactoring) {
		for(VariableDeclaration declaration : mergeVariableRefactoring.mergedVariables) {
