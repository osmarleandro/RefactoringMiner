...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public VariableDeclaration getOriginalAttribute(ChangeAttributeTypeRefactoring changeAttributeTypeRefactoring) {
		return changeAttributeTypeRefactoring.originalAttribute;
	}
}
