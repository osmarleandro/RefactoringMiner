...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(changeVariableTypeRefactoring.getOperationBefore().getLocationInfo().getFilePath(), changeVariableTypeRefactoring.getOperationBefore().getClassName()));
		return pairs;
	}
}
