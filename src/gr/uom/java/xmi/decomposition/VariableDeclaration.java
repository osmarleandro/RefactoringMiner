...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(SplitVariableRefactoring splitVariableRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(splitVariableRefactoring.getOperationBefore().getLocationInfo().getFilePath(), splitVariableRefactoring.getOperationBefore().getClassName()));
		return pairs;
	}
}
