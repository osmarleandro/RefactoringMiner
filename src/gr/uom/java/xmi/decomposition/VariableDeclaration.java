...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<VariableDeclaration> getMergedAttributes(MergeAttributeRefactoring mergeAttributeRefactoring) {
		return mergeAttributeRefactoring.mergedAttributes;
	}
}
