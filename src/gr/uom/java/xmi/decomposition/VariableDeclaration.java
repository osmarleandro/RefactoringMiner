...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<AbstractCodeMapping> getVariableReferences(SplitVariableRefactoring splitVariableRefactoring) {
		return splitVariableRefactoring.variableReferences;
	}
}
