...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(SplitAttributeRefactoring splitAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(splitAttributeRefactoring.getOldAttribute().getLocationInfo().getFilePath(), splitAttributeRefactoring.getClassNameBefore()));
		return pairs;
	}
}
