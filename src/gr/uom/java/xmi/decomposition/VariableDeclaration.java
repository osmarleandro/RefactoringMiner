...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<Refactoring> getRelatedRefactorings(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		return changeVariableTypeRefactoring.relatedRefactorings;
	}
}
