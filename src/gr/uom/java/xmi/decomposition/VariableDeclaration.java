...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<AbstractCodeMapping> getVariableReferences(MergeVariableRefactoring mergeVariableRefactoring) {
		return mergeVariableRefactoring.variableReferences;
	}
}
