...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(ChangeAttributeTypeRefactoring changeAttributeTypeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(changeAttributeTypeRefactoring.getOriginalAttribute().getLocationInfo().getFilePath(), changeAttributeTypeRefactoring.getClassNameBefore()));
		return pairs;
	}
}
