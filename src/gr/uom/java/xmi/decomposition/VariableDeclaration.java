...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public String getName(ChangeAttributeTypeRefactoring changeAttributeTypeRefactoring) {
		return changeAttributeTypeRefactoring.getRefactoringType().getDisplayName();
	}
}
