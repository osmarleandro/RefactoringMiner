...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public String getName(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		return changeVariableTypeRefactoring.getRefactoringType().getDisplayName();
	}
}
