...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<AbstractCodeMapping> getVariableReferences(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		return changeVariableTypeRefactoring.variableReferences;
	}
}
