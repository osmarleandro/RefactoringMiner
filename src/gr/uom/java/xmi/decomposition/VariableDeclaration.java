...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public List<CodeRange> leftSide(MergeVariableRefactoring mergeVariableRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		for(VariableDeclaration mergedVariable : mergeVariableRefactoring.mergedVariables) {
