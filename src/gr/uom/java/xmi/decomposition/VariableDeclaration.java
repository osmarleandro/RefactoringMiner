...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public VariableDeclaration getOriginalVariable(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		return changeVariableTypeRefactoring.originalVariable;
	}
}
