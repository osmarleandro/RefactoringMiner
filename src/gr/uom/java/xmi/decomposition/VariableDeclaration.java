...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public List<CodeRange> rightSide(SplitVariableRefactoring splitVariableRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		for(VariableDeclaration splitVariable : splitVariableRefactoring.splitVariables) {
