...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(MergeVariableRefactoring mergeVariableRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(mergeVariableRefactoring.getOperationBefore().getLocationInfo().getFilePath(), mergeVariableRefactoring.getOperationBefore().getClassName()));
		return pairs;
	}
}
