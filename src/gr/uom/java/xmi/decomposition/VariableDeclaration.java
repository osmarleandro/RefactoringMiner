...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(SplitVariableRefactoring splitVariableRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(splitVariableRefactoring.getOperationAfter().getLocationInfo().getFilePath(), splitVariableRefactoring.getOperationAfter().getClassName()));
		return pairs;
	}
}
