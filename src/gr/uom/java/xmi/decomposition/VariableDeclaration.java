...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<CandidateMergeVariableRefactoring> getAttributeMerges(MergeAttributeRefactoring mergeAttributeRefactoring) {
		return mergeAttributeRefactoring.attributeMerges;
	}
}
