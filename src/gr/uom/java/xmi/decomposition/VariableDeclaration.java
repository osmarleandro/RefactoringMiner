...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(MergeAttributeRefactoring mergeAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		for(VariableDeclaration mergedAttribute : mergeAttributeRefactoring.mergedAttributes) {
			pairs.add(new ImmutablePair<String, String>(mergedAttribute.getLocationInfo().getFilePath(), mergeAttributeRefactoring.getClassNameBefore()));
		}
		return pairs;
	}
}
