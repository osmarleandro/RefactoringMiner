...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(RenameAttributeRefactoring renameAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(renameAttributeRefactoring.getOriginalAttribute().getLocationInfo().getFilePath(), renameAttributeRefactoring.getClassNameBefore()));
		return pairs;
	}
}
