...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public void setRenamedVariableDeclaration(CandidateAttributeRefactoring candidateAttributeRefactoring) {
		candidateAttributeRefactoring.renamedVariableDeclaration = this;
	}
}
