...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(SplitAttributeRefactoring splitAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		for(VariableDeclaration splitAttribute : splitAttributeRefactoring.splitAttributes) {
			pairs.add(new ImmutablePair<String, String>(splitAttribute.getLocationInfo().getFilePath(), splitAttributeRefactoring.getClassNameAfter()));
		}
		return pairs;
	}
}
