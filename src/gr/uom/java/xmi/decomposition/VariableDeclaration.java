...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public UMLOperation getOperationBefore(ChangeVariableTypeRefactoring changeVariableTypeRefactoring) {
		return changeVariableTypeRefactoring.operationBefore;
	}
}
