...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public List<CodeRange> rightSide(RenameAttributeRefactoring renameAttributeRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		ranges.add(renameAttributeRefactoring.renamedAttribute.codeRange()
				.setDescription("renamed attribute declaration")
				.setCodeElement(renameAttributeRefactoring.renamedAttribute.toString()));
		return ranges;
	}
}
