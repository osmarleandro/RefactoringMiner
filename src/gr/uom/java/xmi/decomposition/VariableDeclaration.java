...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<CandidateAttributeRefactoring> getAttributeRenames(RenameAttributeRefactoring renameAttributeRefactoring) {
		return renameAttributeRefactoring.attributeRenames;
	}
}
