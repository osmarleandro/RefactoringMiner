...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(RenameAttributeRefactoring renameAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(renameAttributeRefactoring.getRenamedAttribute().getLocationInfo().getFilePath(), renameAttributeRefactoring.getClassNameAfter()));
		return pairs;
	}
}
