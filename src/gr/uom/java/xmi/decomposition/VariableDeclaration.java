...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public VariableDeclaration getRenamedAttribute(RenameAttributeRefactoring renameAttributeRefactoring) {
		return renameAttributeRefactoring.renamedAttribute;
	}
}
