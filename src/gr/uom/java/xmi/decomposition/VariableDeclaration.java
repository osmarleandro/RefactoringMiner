...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(MergeVariableRefactoring mergeVariableRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(mergeVariableRefactoring.getOperationAfter().getLocationInfo().getFilePath(), mergeVariableRefactoring.getOperationAfter().getClassName()));
		return pairs;
	}
}
