...
public class VariableDeclaration implements LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<CandidateSplitVariableRefactoring> getAttributeSplits(SplitAttributeRefactoring splitAttributeRefactoring) {
		return splitAttributeRefactoring.attributeSplits;
	}
}
