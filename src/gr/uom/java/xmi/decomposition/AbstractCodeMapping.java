...
public abstract class AbstractCodeMapping {
	...
	private boolean reservedTokenMatch(AbstractExpression initializer, Replacement replacement, String replacedExpression) {
		...
		String initializerReservedTokens = ReplacementUtil_RENAMED.keepReservedTokens(initializer.toString());
		String replacementReservedTokens = ReplacementUtil_RENAMED.keepReservedTokens(replacedExpression);
