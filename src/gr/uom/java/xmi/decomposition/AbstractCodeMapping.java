			...
			for(Replacement replacement : getReplacements()) {
				...
				if(variableName.equals(replacement.getAfter()) && initializer != null) {
					if(initializer.toString().equals(replacement.getBefore()) ||
							(initializer.toString().equals("(" + declaration.getInitializer().getType(this) + ")" + replacement.getBefore()) && !containsVariableNameReplacement(variableName)) ||
			...
			for(Replacement replacement : getReplacements()) {
				...
				if(variableName.equals(replacement.getBefore()) && initializer != null) {
					if(initializer.toString().equals(replacement.getAfter()) ||
							(initializer.toString().equals("(" + declaration.getInitializer().getType(this) + ")" + replacement.getAfter()) && !containsVariableNameReplacement(variableName)) ||
