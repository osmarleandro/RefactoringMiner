...
public class VariableReferenceExtractor {
	...
	public static Set<AbstractCodeMapping> findReferences(VariableDeclaration_RENAMED declaration1, VariableDeclaration_RENAMED declaration2, Set<AbstractCodeMapping> mappings) {
	...
	private static boolean usesVariable(AbstractCodeFragment fragment, VariableDeclaration_RENAMED declaration) {
	...
	public static Set<AbstractCodeMapping> findReferences(VariableDeclaration_RENAMED declaration1, VariableDeclaration_RENAMED declaration2, List<UMLOperationBodyMapper> operationBodyMapperList) {
		Set<AbstractCodeMapping> references = new LinkedHashSet<AbstractCodeMapping>();
