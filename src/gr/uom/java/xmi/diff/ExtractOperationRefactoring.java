...
public class ExtractOperationRefactoring implements Refactoring {
	...
	private String getClassName() {
		...
		String targetClassName = bodyMapper.getSourceOperationAfterExtraction(this).getClassName();
	...
	public RefactoringType getRefactoringType() {
		if(!bodyMapper.getSourceOperationAfterExtraction(this).getClassName().equals(getExtractedOperation().getClassName()))
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(bodyMapper.getSourceOperationAfterExtraction(this).getLocationInfo().getFilePath(), bodyMapper.getSourceOperationAfterExtraction(this).getClassName()));
