...
public class ExtractOperationRefactoring implements Refactoring {
	...
	private String getClassName() {
		...
		String sourceClassName = sourceOperationBeforeExtraction.getClassName();
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		pairs.add(new ImmutablePair<String, String>(sourceOperationBeforeExtraction.getLocationInfo().getFilePath(), sourceOperationBeforeExtraction.getClassName()));
		return pairs;
	}
