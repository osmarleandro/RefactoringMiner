...
public class ExtractOperationRefactoring implements Refactoring {
	...
	public String toString() {
		...
		if(getRefactoringType().equals(RefactoringType.EXTRACT_AND_MOVE_OPERATION)) {
			...
			sb.append(extractedOperation.className);
		}
		return sb.toString();
	}
	...
	private String getClassName() {
		if(getRefactoringType().equals(RefactoringType.EXTRACT_AND_MOVE_OPERATION)) {
			return getSourceOperationBeforeExtraction().className;
		}
		String sourceClassName = getSourceOperationBeforeExtraction().className;
		String targetClassName = getSourceOperationAfterExtraction().className;
	...
	public RefactoringType getRefactoringType() {
		if(!getSourceOperationAfterExtraction().className.equals(getExtractedOperation().className))
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		pairs.add(new ImmutablePair<String, String>(getSourceOperationBeforeExtraction().getLocationInfo().getFilePath(), getSourceOperationBeforeExtraction().className));
		return pairs;
	}

	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getSourceOperationAfterExtraction().getLocationInfo().getFilePath(), getSourceOperationAfterExtraction().className));
		pairs.add(new ImmutablePair<String, String>(getExtractedOperation().getLocationInfo().getFilePath(), getExtractedOperation().className));
		return pairs;
	}
