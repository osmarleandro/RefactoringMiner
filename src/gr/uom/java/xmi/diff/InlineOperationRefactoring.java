...
public class InlineOperationRefactoring implements Refactoring {
	...
	public String toString() {
		...
		if(getRefactoringType().equals(RefactoringType.INLINE_OPERATION)) {
			...
			sb.append(inlinedOperation.className);
			sb.append(" to class ");
			sb.append(getTargetOperationAfterInline().className);
			sb.append(" & inlined to ");
	...
	private String getClassName() {
		return targetOperationAfterInline.className;
	}
	...
	public RefactoringType getRefactoringType() {
		if (!getTargetOperationBeforeInline().className.equals(getInlinedOperation().className))
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		pairs.add(new ImmutablePair<String, String>(getInlinedOperation().getLocationInfo().getFilePath(), getInlinedOperation().className));
		pairs.add(new ImmutablePair<String, String>(getTargetOperationBeforeInline().getLocationInfo().getFilePath(), getTargetOperationBeforeInline().className));
		return pairs;
	}

	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getTargetOperationAfterInline().getLocationInfo().getFilePath(), getTargetOperationAfterInline().className));
		return pairs;
	}
