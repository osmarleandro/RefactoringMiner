...
public class InlineOperationRefactoring implements Refactoring {
	...
	public String toString() {
		...
		if(getRefactoringType().equals(RefactoringType.INLINE_OPERATION)) {
			...
			sb.append(inlinedOperation.getClassName_RENAMED());
			sb.append(" to class ");
			sb.append(getTargetOperationAfterInline().getClassName_RENAMED());
			sb.append(" & inlined to ");
	...
	private String getClassName() {
		return targetOperationAfterInline.getClassName_RENAMED();
	}
	...
	public RefactoringType getRefactoringType() {
		if (!getTargetOperationBeforeInline().getClassName_RENAMED().equals(getInlinedOperation().getClassName_RENAMED()))
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		pairs.add(new ImmutablePair<String, String>(getInlinedOperation().getLocationInfo().getFilePath(), getInlinedOperation().getClassName_RENAMED()));
		pairs.add(new ImmutablePair<String, String>(getTargetOperationBeforeInline().getLocationInfo().getFilePath(), getTargetOperationBeforeInline().getClassName_RENAMED()));
		return pairs;
	}

	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getTargetOperationAfterInline().getLocationInfo().getFilePath(), getTargetOperationAfterInline().getClassName_RENAMED()));
		return pairs;
	}
