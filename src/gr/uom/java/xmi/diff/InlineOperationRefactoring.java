...
public class InlineOperationRefactoring implements Refactoring {
	...
	public RefactoringType getRefactoringType() {
		if (!targetOperationBeforeInline.getClassName().equals(getInlinedOperation().getClassName()))
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		pairs.add(new ImmutablePair<String, String>(targetOperationBeforeInline.getLocationInfo().getFilePath(), targetOperationBeforeInline.getClassName()));
		return pairs;
	}
