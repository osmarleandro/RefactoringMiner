...
public class RenamePackageRefactoring implements Refactoring {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		for(MoveClassRefactoring ref : moveClassRefactorings) {
			pairs.add(new ImmutablePair<String, String>(ref.getMovedClass().getMovedClass().getLocationInfo().getFilePath(), ref.getMovedClassName()));
		}
		return pairs;
	}
	...
	public List<CodeRange> rightSide() {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		for(MoveClassRefactoring ref : moveClassRefactorings) {
			ranges.add(ref.getMovedClass().getMovedClass().codeRange()
					.setDescription("moved type declaration")
					.setCodeElement(ref.getMovedClass().getMovedClass().getName()));
		}
		return ranges;
	}
}
