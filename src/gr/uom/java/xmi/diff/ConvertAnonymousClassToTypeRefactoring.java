...
public class ConvertAnonymousClassToTypeRefactoring implements Refactoring {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getAddedClass().getLocationInfo().getFilePath(), getAddedClass().getJavadoc().getName(this)));
		return pairs;
	}
	...
	public List<CodeRange> rightSide() {
		...
		ranges.add(addedClass.codeRange()
				...
				.setCodeElement(addedClass.getJavadoc().getName(this)));
		return ranges;
	}
}
