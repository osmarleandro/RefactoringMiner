...
public class ClassRenameComparator implements Comparator<UMLClassRenameDiff> {
	...
	public int compare(UMLClassRenameDiff o1, UMLClassRenameDiff o2) {
		double nameDistance1 = o1.getOriginalClass().normalizedNameDistance(o1.getRenamedClass());
		double nameDistance2 = o2.getOriginalClass().normalizedNameDistance(o2.getRenamedClass());
