...
public class RenameClassRefactoring implements Refactoring {
	...
	public String toString() {
		...
		sb.append(renamedClass.getJavadoc().getName(this));
		return sb.toString();
	}
	...
	public String getRenamedClassName() {
		return renamedClass.getJavadoc().getName(this);
	}
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getRenamedClass().getLocationInfo().getFilePath(), getRenamedClass().getJavadoc().getName(this)));
		return pairs;
	}
	...
	public List<CodeRange> rightSide() {
		...
		ranges.add(renamedClass.codeRange()
				...
				.setCodeElement(renamedClass.getJavadoc().getName(this)));
		return ranges;
	}
}
