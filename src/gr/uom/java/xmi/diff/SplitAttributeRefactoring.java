...
public class SplitAttributeRefactoring implements Refactoring {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		pairs.add(new ImmutablePair<String, String>(getOldAttribute().getLocationInfo_RENAMED().getFilePath(), getClassNameBefore()));
		return pairs;
	}
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		...
		for(VariableDeclaration splitAttribute : this.splitAttributes) {
			pairs.add(new ImmutablePair<String, String>(splitAttribute.getLocationInfo_RENAMED().getFilePath(), getClassNameAfter()));
		}
		return pairs;
	}
