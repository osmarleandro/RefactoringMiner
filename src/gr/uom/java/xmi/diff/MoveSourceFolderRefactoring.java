...
public class MoveSourceFolderRefactoring implements Refactoring {
	...
	public String toString() {
		...
		String originalPath = pattern.getBefore_RENAMED().endsWith("/") ? pattern.getBefore_RENAMED().substring(0, pattern.getBefore_RENAMED().length()-1) : pattern.getBefore_RENAMED();
