...
public class MoveSourceFolderRefactoring implements Refactoring {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		for(MovedClassToAnotherSourceFolder ref : movedClassesToAnotherSourceFolder) {
			pairs.add(new ImmutablePair<String, String>(ref.movedClass.getLocationInfo().getFilePath(), ref.getMovedClassName()));
		}
		return pairs;
	}
	...
	public List<CodeRange> rightSide() {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		for(MovedClassToAnotherSourceFolder ref : movedClassesToAnotherSourceFolder) {
			ranges.add(ref.movedClass.codeRange()
					.setDescription("moved type declaration")
					.setCodeElement(ref.movedClass.getName()));
		}
		return ranges;
	}
}
