...
public class UMLAnnotationListDiff {
	...
	public UMLAnnotationListDiff(List<UMLAnnotation> annotations1, List<UMLAnnotation> annotations2) {
		...
		for(SimpleEntry<UMLAnnotation, UMLAnnotation> entry : matchedAnnotations) {
			...
			if(!(!annotationDiff.typeNameChanged && !annotationDiff.valueChanged && !annotationDiff.valueAdded && !annotationDiff.valueRemoved &&
			annotationDiff.removedMemberValuePairs.isEmpty() && annotationDiff.addedMemberValuePairs.isEmpty() &&
			annotationDiff.matchedMemberValuePairsWithDifferentExpressions.isEmpty())) {
