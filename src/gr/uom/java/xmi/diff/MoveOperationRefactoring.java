...
public class MoveOperationRefactoring implements Refactoring {
	...
	public boolean compatibleWith(MoveAttributeRefactoring ref) {
		if(ref.getMovedAttribute().className.equals(this.movedOperation.getClassName()) &&
				ref.getOriginalAttribute().className.equals(this.originalOperation.getClassName())) {
