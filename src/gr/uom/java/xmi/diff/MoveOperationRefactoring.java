...
public class MoveOperationRefactoring implements Refactoring {
	...
	public boolean compatibleWith(MoveAttributeRefactoring ref) {
		if(ref.getMovedAttribute().getJavadoc().getClassName(this).equals(this.movedOperation.getClassName()) &&
				ref.getOriginalAttribute().getJavadoc().getClassName(this).equals(this.originalOperation.getClassName())) {
