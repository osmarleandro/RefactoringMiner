			...
			for(AbstractCodeMapping mapping : mappings) {
				for(Replacement replacement : mapping.getReplacements()) {
					if(replacement.getType().equals(ReplacementType.VARIABLE_NAME)) {
						if(replacement.getBefore().equals(originalVariable.variableName) && !replacement.getAfter().equals(newVariable.variableName)) {
							return true;
						}
						else if(!replacement.getBefore().equals(originalVariable.variableName) && replacement.getAfter().equals(newVariable.variableName)) {
							return true;
						}
					}
				}
