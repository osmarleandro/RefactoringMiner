...
public class UMLOperationDiff {
	...
	public boolean isEmpty() {
		...
		!visibilityChanged && !abstractionChanged && !returnTypeChanged && !operationRenamed && annotationListDiff.removedAnnotations.isEmpty() && annotationListDiff.addedAnnotations.isEmpty() && annotationListDiff.annotationDiffList.isEmpty();
	}
