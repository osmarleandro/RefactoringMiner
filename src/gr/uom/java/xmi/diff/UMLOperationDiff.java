...
public class UMLOperationDiff {
	...
	public UMLOperationDiff(UMLOperation removedOperation, UMLOperation addedOperation) {
		...
		List<UMLParameter> removedParametersWithoutReturnType = removedOperation.getJavadoc().getParametersWithoutReturnType(this);
		List<UMLParameter> addedParametersWithoutReturnType = addedOperation.getJavadoc().getParametersWithoutReturnType(this);
