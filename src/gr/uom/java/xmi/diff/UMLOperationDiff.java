...
public class UMLOperationDiff {
	...
	public UMLOperationDiff(UMLOperation removedOperation, UMLOperation addedOperation) {
		...
		if(!removedOperation.visibility.equals(addedOperation.visibility))
	...
	public String toString() {
		...
		if(visibilityChanged)
			sb.append("\t").append("visibility changed from " + removedOperation.visibility + " to " + addedOperation.visibility).append("\n");
