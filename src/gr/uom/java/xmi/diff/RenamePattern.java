...
public class RenamePattern {
	...
	public List<MovedClassToAnotherSourceFolder> getMovedClassesToAnotherSourceFolder(MoveSourceFolderRefactoring moveSourceFolderRefactoring) {
		return moveSourceFolderRefactoring.movedClassesToAnotherSourceFolder;
	}
}
