...
public class ClassMoveComparator implements Comparator<UMLClassMoveDiff> {
	...
	public int compare(UMLClassMoveDiff o1, UMLClassMoveDiff o2) {
		double sourceFolderDistance1 = o1.nextClass.normalizedSourceFolderDistance(o1.getOriginalClass());
		double sourceFolderDistance2 = o2.nextClass.normalizedSourceFolderDistance(o2.getOriginalClass());
