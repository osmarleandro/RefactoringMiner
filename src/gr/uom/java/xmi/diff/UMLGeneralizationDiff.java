...
public class UMLGeneralizationDiff implements Comparable<UMLGeneralizationDiff> {
	...
	public UMLGeneralizationDiff(UMLGeneralization removedGeneralization, UMLGeneralization addedGeneralization) {
		...
		if(!removedGeneralization.parent.equals(addedGeneralization.parent))
			parentChanged = true;
	...
	public String toString() {
		...
		if(parentChanged)
			sb.append("\t").append("parent changed from " + removedGeneralization.parent + " to " + addedGeneralization.parent).append("\n");
		return sb.toString();
	}
