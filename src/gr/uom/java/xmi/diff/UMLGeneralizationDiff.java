...
public class UMLGeneralizationDiff implements Comparable<UMLGeneralizationDiff> {
	...
	public UMLGeneralizationDiff(UMLGeneralization removedGeneralization, UMLGeneralization addedGeneralization) {
		...
		if(!removedGeneralization.getChild().getParent(this).equals(addedGeneralization.getChild().getParent(this)))
			parentChanged = true;
	...
	public String toString() {
		...
		if(parentChanged)
			sb.append("\t").append("parent changed from " + removedGeneralization.getChild().getParent(this) + " to " + addedGeneralization.getChild().getParent(this)).append("\n");
		return sb.toString();
	}
