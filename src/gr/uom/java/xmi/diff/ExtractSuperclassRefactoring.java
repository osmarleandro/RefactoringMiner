...
public class ExtractSuperclassRefactoring implements Refactoring {
	...
	public Set<String> getSubclassSet() {
		...
		for(UMLClass umlClass : this.subclassSet) {
			subclassSet.add(umlClass.getJavadoc().getName(this));
		}
		return subclassSet;
	}
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		for(UMLClass umlClass : this.subclassSet) {
			pairs.add(new ImmutablePair<String, String>(umlClass.getLocationInfo().getFilePath(), umlClass.getJavadoc().getName(this)));
		}
		return pairs;
	}
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getExtractedClass().getLocationInfo().getFilePath(), getExtractedClass().getJavadoc().getName(this)));
		return pairs;
	}
	...
	public List<CodeRange> leftSide() {
		...
		for(UMLClass subclass : subclassSet) {
			ranges.add(subclass.codeRange()
					...
					.setCodeElement(subclass.getJavadoc().getName(this)));
		}
		return ranges;
	}
	...
	public List<CodeRange> rightSide() {
		...
		ranges.add(extractedClass.codeRange()
				...
				.setCodeElement(extractedClass.getJavadoc().getName(this)));
		return ranges;
	}
}
