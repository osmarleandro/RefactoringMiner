...
public class RenameOperationRefactoring implements Refactoring {
	...
	private IUMLOperationBodyMapper bodyMapper;
	
	public RenameOperationRefactoring(IUMLOperationBodyMapper bodyMapper) {
	...
	public IUMLOperationBodyMapper getBodyMapper() {
		return bodyMapper;
	}
