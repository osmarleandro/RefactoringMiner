...
public class RenameOperationRefactoring implements Refactoring {
	...
	private String getClassName() {
		String sourceClassName = originalOperation.getJavadoc().getClassName(this);
		String targetClassName = renamedOperation.getJavadoc().getClassName(this);
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getRenamedOperation().getLocationInfo().getFilePath(), getRenamedOperation().getJavadoc().getClassName(this)));
		return pairs;
	}
