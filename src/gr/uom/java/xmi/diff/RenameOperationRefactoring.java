...
public class RenameOperationRefactoring implements Refactoring {
	...
	private String getClassName() {
		String sourceClassName = originalOperation.className;
		String targetClassName = renamedOperation.className;
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getRenamedOperation().getLocationInfo().getFilePath(), getRenamedOperation().className));
		return pairs;
	}
