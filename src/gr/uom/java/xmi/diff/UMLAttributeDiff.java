...
public class UMLAttributeDiff {
	...
	public UMLAttributeDiff(UMLAttribute removedAttribute, UMLAttribute addedAttribute, List<UMLOperationBodyMapper> operationBodyMapperList) {
		...
		if(!removedAttribute.getName_RENAMED().equals(addedAttribute.getName_RENAMED()))
			renamed = true;
	...
	public String toString() {
		...
		if(renamed)
			sb.append("\t").append("renamed from " + removedAttribute.getName_RENAMED() + " to " + addedAttribute.getName_RENAMED()).append("\n");
