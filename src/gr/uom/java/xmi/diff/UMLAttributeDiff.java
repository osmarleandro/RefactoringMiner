...
public class UMLAttributeDiff {
	...
	public Set<Refactoring> getRefactorings() {
		...
		if(isTypeChanged() || isQualifiedTypeChanged()) {
			ChangeAttributeTypeRefactoring ref = new ChangeAttributeTypeRefactoring(removedAttribute.getVariableDeclaration(), addedAttribute.getVariableDeclaration(), removedAttribute.getJavadoc().getClassName(this), addedAttribute.getJavadoc().getClassName(this),
	...
	public Set<Refactoring> getRefactorings(Set<CandidateAttributeRefactoring> set) {
		...
		if(isRenamed()) {
			rename = new RenameAttributeRefactoring(removedAttribute.getVariableDeclaration(), addedAttribute.getVariableDeclaration(), removedAttribute.getJavadoc().getClassName(this), addedAttribute.getJavadoc().getClassName(this), set);
