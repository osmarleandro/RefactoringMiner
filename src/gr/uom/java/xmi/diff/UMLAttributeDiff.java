...
public class UMLAttributeDiff {
	...
	public UMLAttributeDiff(UMLAttribute removedAttribute, UMLAttribute addedAttribute, List<UMLOperationBodyMapper> operationBodyMapperList) {
		...
		if(removedAttribute.getJavadoc().isStatic(this) != addedAttribute.getJavadoc().isStatic(this))
			staticChanged = true;
	...
	public String toString() {
		...
		if(staticChanged)
			sb.append("\t").append("modifier changed from " + (removedAttribute.getJavadoc().isStatic(this) ? "static" : "non-static") + " to " +
					(addedAttribute.getJavadoc().isStatic(this) ? "static" : "non-static")).append("\n");
		if(finalChanged)
