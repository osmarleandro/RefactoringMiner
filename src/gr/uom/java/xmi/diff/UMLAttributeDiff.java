...
public class UMLAttributeDiff {
	...
	public Set<Refactoring> getRefactorings() {
		...
		if(isTypeChanged() || isQualifiedTypeChanged()) {
			ChangeAttributeTypeRefactoring ref = new ChangeAttributeTypeRefactoring(removedAttribute.getVariableDeclaration(), addedAttribute.getVariableDeclaration(), removedAttribute.className, addedAttribute.className,
	...
	public Set<Refactoring> getRefactorings(Set<CandidateAttributeRefactoring> set) {
		...
		if(isRenamed()) {
			rename = new RenameAttributeRefactoring(removedAttribute.getVariableDeclaration(), addedAttribute.getVariableDeclaration(), removedAttribute.className, addedAttribute.className, set);
