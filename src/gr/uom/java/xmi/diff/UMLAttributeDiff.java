...
public class UMLAttributeDiff {
	...
	public UMLAttributeDiff(UMLAttribute removedAttribute, UMLAttribute addedAttribute, List<UMLOperationBodyMapper> operationBodyMapperList) {
		...
		if(!removedAttribute.getName().equals(addedAttribute.getName()))
			renamed = true;
		if(!removedAttribute.getVisibility_RENAMED().equals(addedAttribute.getVisibility_RENAMED()))
	...
	public String toString() {
		...
		if(visibilityChanged)
			sb.append("\t").append("visibility changed from " + removedAttribute.getVisibility_RENAMED() + " to " + addedAttribute.getVisibility_RENAMED()).append("\n");
