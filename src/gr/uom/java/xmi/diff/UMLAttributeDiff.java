...
public class UMLAttributeDiff {
	...
	public String toString() {
		...
		for(UMLAnnotationDiff annotationDiff : annotationListDiff.getAnnotationDiffList()) {
			sb.append("\t").append("annotation " + annotationDiff.getRemovedAnnotation() + " modified to " + annotationDiff.addedAnnotation).append("\n");
		}
		return sb.toString();
	}
	...
	private Set<Refactoring> getAnnotationRefactorings() {
		...
		for(UMLAnnotationDiff annotationDiff : annotationListDiff.getAnnotationDiffList()) {
			ModifyAttributeAnnotationRefactoring refactoring = new ModifyAttributeAnnotationRefactoring(annotationDiff.getRemovedAnnotation(), annotationDiff.addedAnnotation, removedAttribute, addedAttribute);
			refactorings.add(refactoring);
		}
		return refactorings;
	}
