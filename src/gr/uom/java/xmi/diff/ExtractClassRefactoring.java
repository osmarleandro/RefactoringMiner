...
public class ExtractClassRefactoring implements Refactoring {
	...
	public String toString() {
		...
		sb.append(classDiff.getOriginalClass_RENAMED());
		return sb.toString();
	}

	public RefactoringType getRefactoringType() {
		if(extractedClass.isSubTypeOf(classDiff.getOriginalClass_RENAMED()) || extractedClass.isSubTypeOf(classDiff.getNextClass()))
	...
	public UMLClass getOriginalClass() {
		return classDiff.getOriginalClass_RENAMED();
	}
	...
	public List<CodeRange> leftSide() {
		...
		ranges.add(classDiff.getOriginalClass_RENAMED().codeRange()
				.setDescription("original type declaration")
				.setCodeElement(classDiff.getOriginalClass_RENAMED().getName()));
		return ranges;
	}
