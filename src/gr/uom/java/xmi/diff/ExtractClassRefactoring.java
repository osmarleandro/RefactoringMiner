...
public class ExtractClassRefactoring implements Refactoring {
	...
	public String toString() {
		...
		sb.append(classDiff.originalClass);
		return sb.toString();
	}

	public RefactoringType getRefactoringType() {
		if(extractedClass.isSubTypeOf(classDiff.originalClass) || extractedClass.isSubTypeOf(classDiff.getNextClass()))
	...
	public UMLClass getOriginalClass() {
		return classDiff.originalClass;
	}
	...
	public List<CodeRange> leftSide() {
		...
		ranges.add(classDiff.originalClass.codeRange()
				.setDescription("original type declaration")
				.setCodeElement(classDiff.originalClass.getName()));
		return ranges;
	}
