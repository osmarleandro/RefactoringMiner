...
public class MergeAttributeRefactoring implements Refactoring {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring() {
		...
		for(VariableDeclaration mergedAttribute : this.mergedAttributes) {
			pairs.add(new ImmutablePair<String, String>(mergedAttribute.getLocationInfo().filePath, getClassNameBefore()));
		}
		return pairs;
	}
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getNewAttribute().getLocationInfo().filePath, getClassNameAfter()));
		return pairs;
	}
