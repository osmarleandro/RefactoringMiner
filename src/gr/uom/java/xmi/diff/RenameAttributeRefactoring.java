...
public class RenameAttributeRefactoring implements Refactoring {
	...
	public VariableDeclaration getRenamedAttribute_RENAMED() {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring() {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(getRenamedAttribute_RENAMED().getLocationInfo().getFilePath(), getClassNameAfter()));
		return pairs;
	}
