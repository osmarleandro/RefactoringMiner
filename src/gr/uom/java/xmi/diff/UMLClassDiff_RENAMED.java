...
public class UMLClassDiff_RENAMED extends UMLClassBaseDiff {
	
	private String className;
	public UMLClassDiff_RENAMED(UMLClass originalClass, UMLClass nextClass, UMLModelDiff modelDiff) {
