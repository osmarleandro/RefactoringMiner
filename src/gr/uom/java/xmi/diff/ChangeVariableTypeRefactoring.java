...
public class ChangeVariableTypeRefactoring implements Refactoring {
	...
	public String toString() {
		...
		sb.append(qualified ? originalVariable.toQualifiedString_RENAMED() : originalVariable.toString());
		sb.append(" to ");
		sb.append(qualified ? changedTypeVariable.toQualifiedString_RENAMED() : changedTypeVariable.toString());
		sb.append(" in method ");
