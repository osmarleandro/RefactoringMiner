...
public class MoveAttributeRefactoring implements Refactoring {
	...
	public String toString() {
		...
		sb.append(originalAttribute.getClassName());
		sb.append(" to ");
	...
	public boolean equals(Object o) {
		...
		if(o instanceof MoveAttributeRefactoring) {
			...
			return this.originalAttribute.equals(other.originalAttribute) &&
				...
				this.originalAttribute.getClassName().equals(other.originalAttribute.getClassName()) &&
	...
	public int hashCode() {
		if(hashCode == 0) {
			...
			result = 37*result + originalAttribute.getClassName().hashCode();
