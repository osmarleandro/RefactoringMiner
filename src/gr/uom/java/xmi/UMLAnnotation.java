...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String getName(ModifyAttributeAnnotationRefactoring modifyAttributeAnnotationRefactoring) {
		return modifyAttributeAnnotationRefactoring.getRefactoringType().getDisplayName();
	}
}
