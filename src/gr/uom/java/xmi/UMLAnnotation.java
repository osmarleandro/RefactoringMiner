...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public int hashCode(AddAttributeAnnotationRefactoring addAttributeAnnotationRefactoring) {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((this == null) ? 0 : hashCode());
		result = prime * result + ((addAttributeAnnotationRefactoring.attributeAfter == null) ? 0 : addAttributeAnnotationRefactoring.attributeAfter.hashCode());
		result = prime * result + ((addAttributeAnnotationRefactoring.attributeBefore == null) ? 0 : addAttributeAnnotationRefactoring.attributeBefore.hashCode());
		return result;
	}
}
