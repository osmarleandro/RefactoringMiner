...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String toString(AddAttributeAnnotationRefactoring addAttributeAnnotationRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(addAttributeAnnotationRefactoring.getName()).append("\t");
		sb.append(this);
		sb.append(" in attribute ");
		sb.append(addAttributeAnnotationRefactoring.attributeAfter);
		sb.append(" from class ");
		sb.append(addAttributeAnnotationRefactoring.attributeAfter.getClassName());
		return sb.toString();
	}
}
