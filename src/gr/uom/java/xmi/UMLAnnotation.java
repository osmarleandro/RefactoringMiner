...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String getName(RemoveMethodAnnotationRefactoring removeMethodAnnotationRefactoring) {
		return removeMethodAnnotationRefactoring.getRefactoringType().getDisplayName();
	}
}
