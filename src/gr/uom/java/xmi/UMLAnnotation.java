...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String getName(AddMethodAnnotationRefactoring addMethodAnnotationRefactoring) {
		return addMethodAnnotationRefactoring.getRefactoringType().getDisplayName();
	}
}
