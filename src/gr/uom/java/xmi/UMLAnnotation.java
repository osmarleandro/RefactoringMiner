...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String toString(RemoveAttributeAnnotationRefactoring removeAttributeAnnotationRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(removeAttributeAnnotationRefactoring.getName()).append("\t");
		sb.append(this);
		sb.append(" in attribute ");
		sb.append(removeAttributeAnnotationRefactoring.attributeBefore);
		sb.append(" from class ");
		sb.append(removeAttributeAnnotationRefactoring.attributeBefore.getClassName());
		return sb.toString();
	}
}
