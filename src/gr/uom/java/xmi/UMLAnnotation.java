...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAnnotation getAnnotationBefore(ModifyAttributeAnnotationRefactoring modifyAttributeAnnotationRefactoring) {
		return modifyAttributeAnnotationRefactoring.annotationBefore;
	}
}
