...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLOperation getOperationBefore(RemoveMethodAnnotationRefactoring removeMethodAnnotationRefactoring) {
		return removeMethodAnnotationRefactoring.operationBefore;
	}
}
