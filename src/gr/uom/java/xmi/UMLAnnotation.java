...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public boolean equals(RemoveAttributeAnnotationRefactoring removeAttributeAnnotationRefactoring, Object obj) {
		if (removeAttributeAnnotationRefactoring == obj)
			return true;
		if (obj == null)
			return false;
		if (removeAttributeAnnotationRefactoring.getClass() != obj.getClass())
			return false;
		...
		if (this == null) {
			...
			return false;
		if (removeAttributeAnnotationRefactoring.attributeAfter == null) {
			if (other.attributeAfter != null)
				return false;
		} else if (!removeAttributeAnnotationRefactoring.attributeAfter.equals(other.attributeAfter))
			return false;
		if (removeAttributeAnnotationRefactoring.attributeBefore == null) {
			if (other.attributeBefore != null)
				return false;
		} else if (!removeAttributeAnnotationRefactoring.attributeBefore.equals(other.attributeBefore))
			return false;
		return true;
	}
}
