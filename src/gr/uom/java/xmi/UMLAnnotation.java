...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAttribute getAttributeBefore(AddAttributeAnnotationRefactoring addAttributeAnnotationRefactoring) {
		return addAttributeAnnotationRefactoring.attributeBefore;
	}
}
