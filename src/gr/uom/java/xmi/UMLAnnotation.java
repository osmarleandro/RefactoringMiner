...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String toString(ModifyAttributeAnnotationRefactoring modifyAttributeAnnotationRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(modifyAttributeAnnotationRefactoring.getName()).append("\t");
		sb.append(modifyAttributeAnnotationRefactoring.annotationBefore);
		sb.append(" to ");
		sb.append(this);
		sb.append(" in attribute ");
		sb.append(modifyAttributeAnnotationRefactoring.attributeAfter);
		sb.append(" from class ");
		sb.append(modifyAttributeAnnotationRefactoring.attributeAfter.getClassName());
		return sb.toString();
	}
}
