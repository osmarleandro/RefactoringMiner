...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAnnotation getAnnotationBefore(ModifyMethodAnnotationRefactoring modifyMethodAnnotationRefactoring) {
		return modifyMethodAnnotationRefactoring.annotationBefore;
	}
}
