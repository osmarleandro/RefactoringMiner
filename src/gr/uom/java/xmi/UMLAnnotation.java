...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAttribute getAttributeAfter(AddAttributeAnnotationRefactoring addAttributeAnnotationRefactoring) {
		return addAttributeAnnotationRefactoring.attributeAfter;
	}
}
