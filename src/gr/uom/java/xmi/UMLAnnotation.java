...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLOperation getOperationBefore(AddMethodAnnotationRefactoring addMethodAnnotationRefactoring) {
		return addMethodAnnotationRefactoring.operationBefore;
	}
}
