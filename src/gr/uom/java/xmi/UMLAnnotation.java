...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String getName(AddAttributeAnnotationRefactoring addAttributeAnnotationRefactoring) {
		return addAttributeAnnotationRefactoring.getRefactoringType().getDisplayName();
	}
}
