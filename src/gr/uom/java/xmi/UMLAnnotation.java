...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String toString(AddMethodAnnotationRefactoring addMethodAnnotationRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(addMethodAnnotationRefactoring.getName()).append("\t");
		sb.append(this);
		sb.append(" in method ");
		sb.append(addMethodAnnotationRefactoring.operationAfter);
		sb.append(" from class ");
		sb.append(addMethodAnnotationRefactoring.operationAfter.getClassName());
		return sb.toString();
	}
}
