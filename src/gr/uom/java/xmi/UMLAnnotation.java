...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAttribute getAttributeAfter(RemoveAttributeAnnotationRefactoring removeAttributeAnnotationRefactoring) {
		return removeAttributeAnnotationRefactoring.attributeAfter;
	}
}
