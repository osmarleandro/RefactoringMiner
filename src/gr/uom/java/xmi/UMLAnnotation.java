...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLOperation getOperationAfter(AddMethodAnnotationRefactoring addMethodAnnotationRefactoring) {
		return addMethodAnnotationRefactoring.operationAfter;
	}
}
