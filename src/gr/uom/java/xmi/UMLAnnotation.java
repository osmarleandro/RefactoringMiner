...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public int hashCode(RemoveAttributeAnnotationRefactoring removeAttributeAnnotationRefactoring) {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((this == null) ? 0 : hashCode());
		result = prime * result + ((removeAttributeAnnotationRefactoring.attributeAfter == null) ? 0 : removeAttributeAnnotationRefactoring.attributeAfter.hashCode());
		result = prime * result + ((removeAttributeAnnotationRefactoring.attributeBefore == null) ? 0 : removeAttributeAnnotationRefactoring.attributeBefore.hashCode());
		return result;
	}
}
