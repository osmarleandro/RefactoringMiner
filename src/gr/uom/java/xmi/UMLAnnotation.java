...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public int hashCode(ModifyMethodAnnotationRefactoring modifyMethodAnnotationRefactoring) {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((this == null) ? 0 : hashCode());
		result = prime * result + ((modifyMethodAnnotationRefactoring.annotationBefore == null) ? 0 : modifyMethodAnnotationRefactoring.annotationBefore.hashCode());
		result = prime * result + ((modifyMethodAnnotationRefactoring.operationAfter == null) ? 0 : modifyMethodAnnotationRefactoring.operationAfter.hashCode());
		result = prime * result + ((modifyMethodAnnotationRefactoring.operationBefore == null) ? 0 : modifyMethodAnnotationRefactoring.operationBefore.hashCode());
		return result;
	}
}
