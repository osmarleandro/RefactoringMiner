...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLOperation getOperationAfter(RemoveMethodAnnotationRefactoring removeMethodAnnotationRefactoring) {
		return removeMethodAnnotationRefactoring.operationAfter;
	}
}
