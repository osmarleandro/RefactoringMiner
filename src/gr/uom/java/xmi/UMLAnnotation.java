...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAttribute getAttributeBefore(RemoveAttributeAnnotationRefactoring removeAttributeAnnotationRefactoring) {
		return removeAttributeAnnotationRefactoring.attributeBefore;
	}
}
