...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAttribute getAttributeBefore(ModifyAttributeAnnotationRefactoring modifyAttributeAnnotationRefactoring) {
		return modifyAttributeAnnotationRefactoring.attributeBefore;
	}
}
