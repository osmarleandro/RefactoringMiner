...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public UMLAttribute getAttributeAfter(ModifyAttributeAnnotationRefactoring modifyAttributeAnnotationRefactoring) {
		return modifyAttributeAnnotationRefactoring.attributeAfter;
	}
}
