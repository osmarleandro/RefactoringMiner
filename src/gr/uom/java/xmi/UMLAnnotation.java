...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String getName(ModifyMethodAnnotationRefactoring modifyMethodAnnotationRefactoring) {
		return modifyMethodAnnotationRefactoring.getRefactoringType().getDisplayName();
	}
}
