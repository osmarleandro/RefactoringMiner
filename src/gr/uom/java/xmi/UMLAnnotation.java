...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public boolean isEmpty(UMLAnnotationDiff umlAnnotationDiff) {
		return !umlAnnotationDiff.typeNameChanged && !umlAnnotationDiff.valueChanged && !umlAnnotationDiff.valueAdded && !umlAnnotationDiff.valueRemoved &&
				umlAnnotationDiff.removedMemberValuePairs.isEmpty() && umlAnnotationDiff.addedMemberValuePairs.isEmpty() &&
				umlAnnotationDiff.matchedMemberValuePairsWithDifferentExpressions.isEmpty();
	}
}
