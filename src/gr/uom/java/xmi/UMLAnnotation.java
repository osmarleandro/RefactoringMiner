...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public boolean equals(RemoveMethodAnnotationRefactoring removeMethodAnnotationRefactoring, Object obj) {
		if (removeMethodAnnotationRefactoring == obj)
			return true;
		if (obj == null)
			return false;
		if (removeMethodAnnotationRefactoring.getClass() != obj.getClass())
			return false;
		...
		if (this == null) {
			...
			return false;
		if (removeMethodAnnotationRefactoring.operationAfter == null) {
			if (other.operationAfter != null)
				return false;
		} else if (!removeMethodAnnotationRefactoring.operationAfter.equals(other.operationAfter))
			return false;
		if (removeMethodAnnotationRefactoring.operationBefore == null) {
			if (other.operationBefore != null)
				return false;
		} else if (!removeMethodAnnotationRefactoring.operationBefore.equals(other.operationBefore))
			return false;
		return true;
	}
}
