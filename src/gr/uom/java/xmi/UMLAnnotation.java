...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String getName(RemoveAttributeAnnotationRefactoring removeAttributeAnnotationRefactoring) {
		return removeAttributeAnnotationRefactoring.getRefactoringType().getDisplayName();
	}
}
