...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public int hashCode(AddMethodAnnotationRefactoring addMethodAnnotationRefactoring) {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((this == null) ? 0 : hashCode());
		result = prime * result + ((addMethodAnnotationRefactoring.operationAfter == null) ? 0 : addMethodAnnotationRefactoring.operationAfter.hashCode());
		result = prime * result + ((addMethodAnnotationRefactoring.operationBefore == null) ? 0 : addMethodAnnotationRefactoring.operationBefore.hashCode());
		return result;
	}
}
