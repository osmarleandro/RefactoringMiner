...
public class UMLAnnotation implements Serializable, LocationInfoProvider {
	...
	public String toString(RemoveMethodAnnotationRefactoring removeMethodAnnotationRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(removeMethodAnnotationRefactoring.getName()).append("\t");
		sb.append(this);
		sb.append(" in method ");
		sb.append(removeMethodAnnotationRefactoring.operationBefore);
		sb.append(" from class ");
		sb.append(removeMethodAnnotationRefactoring.operationBefore.getClassName());
		return sb.toString();
	}
}
