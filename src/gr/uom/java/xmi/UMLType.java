...
public abstract class UMLType implements Serializable, LocationInfoProvider {
	...
	public UMLClass looksLikeRemovedClass(UMLModelDiff umlModelDiff) {
		   for(UMLClass umlClass : umlModelDiff.removedClasses) {
		         if(umlClass.getName().endsWith("." + getClassType())) {
		        	 return umlClass;
		         }
		   }
		   return null;
