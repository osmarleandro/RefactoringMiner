...
public abstract class UMLType implements Serializable, LocationInfoProvider {
	...
	public int hashCode(ObjectCreation objectCreation) {
		if(objectCreation.hashCode == 0) {
			int result = 17;
			result = 37*result + hashCode();
			result = 37*result + (objectCreation.isArray ? 1 : 0);
			result = 37*result + objectCreation.typeArguments;
			objectCreation.hashCode = result;
		}
		return objectCreation.hashCode;
	}
