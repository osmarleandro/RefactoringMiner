...
public abstract class UMLType implements Serializable, LocationInfoProvider {
	...
	public boolean equalsQualified(LeafType leafType) {
		if(leafType.getClass() == getClass()) {
			if(leafType.classType.equals(((LeafType)this).classType) && leafType.equalTypeArgumentsAndArrayDimension(this)) {
				return true;
			}
		}
		return false;
