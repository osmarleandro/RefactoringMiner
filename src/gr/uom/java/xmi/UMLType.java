...
public abstract class UMLType implements Serializable, LocationInfoProvider {
	...
	public List<CodeRange> leftSide(ChangeReturnTypeRefactoring changeReturnTypeRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		ranges.add(changeReturnTypeRefactoring.originalType.codeRange()
				.setDescription("original return type")
				.setCodeElement(changeReturnTypeRefactoring.originalType.toString()));
		return ranges;
	}
