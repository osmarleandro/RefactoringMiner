...
public abstract class UMLType implements Serializable, LocationInfoProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(ChangeReturnTypeRefactoring changeReturnTypeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(changeReturnTypeRefactoring.getOperationAfter().getLocationInfo().getFilePath(), changeReturnTypeRefactoring.getOperationAfter().getClassName()));
		return pairs;
	}
