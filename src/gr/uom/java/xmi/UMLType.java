...
public abstract class UMLType implements Serializable, LocationInfoProvider {
	...
	public int hashCode(UMLParameter umlParameter) {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((umlParameter.kind == null) ? 0 : umlParameter.kind.hashCode());
		result = prime * result + ((this == null) ? 0 : hashCode());
		result = prime * result + (umlParameter.varargs ? 1231 : 1237);
		return result;
	}
