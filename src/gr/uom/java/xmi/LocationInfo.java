...
public class LocationInfo {
	...
	public List<VariableDeclaration> getVariableDeclarations(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.variableDeclarations;
	}
