...
public class LocationInfo {
	...
	public List<String> getNumberLiterals(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.numberLiterals;
	}
