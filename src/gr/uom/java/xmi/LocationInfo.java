...
public class LocationInfo {
	...
	public List<String> getBooleanLiterals(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.booleanLiterals;
	}
