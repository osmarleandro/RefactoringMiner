...
public class LocationInfo {
	...
	public List<TernaryOperatorExpression> getTernaryOperatorExpressions(AbstractExpression abstractExpression) {
		return abstractExpression.ternaryOperatorExpressions;
	}
