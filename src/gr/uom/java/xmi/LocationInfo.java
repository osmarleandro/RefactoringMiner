...
public class LocationInfo {
	...
	public Map<String, List<ObjectCreation>> getCreationMap(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.creationMap;
	}
