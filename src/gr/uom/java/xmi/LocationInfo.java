...
public class LocationInfo {
	...
	public List<AnonymousClassDeclarationObject> getAnonymousClassDeclarations(StatementObject statementObject) {
		return statementObject.anonymousClassDeclarations;
	}
