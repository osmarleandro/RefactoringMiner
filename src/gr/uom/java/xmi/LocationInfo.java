...
public class LocationInfo {
	...
	public VariableDeclaration getVariableDeclaration(AbstractExpression abstractExpression, String variableName) {
		List<VariableDeclaration> variableDeclarations = abstractExpression.getVariableDeclarations();
