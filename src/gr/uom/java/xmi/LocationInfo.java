...
public class LocationInfo {
	...
	public AnonymousClassDeclaration getAstNode(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.astNode;
	}
