...
public class LocationInfo {
	...
	public List<String> getArrayAccesses(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.arrayAccesses;
	}
