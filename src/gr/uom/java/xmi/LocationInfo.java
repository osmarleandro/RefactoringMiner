...
public class LocationInfo {
	...
	public Map<String, List<OperationInvocation>> getMethodInvocationMap(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.methodInvocationMap;
	}
