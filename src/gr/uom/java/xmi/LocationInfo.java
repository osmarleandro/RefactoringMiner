...
public class LocationInfo {
	...
	public List<String> getInfixOperators(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.infixOperators;
	}
