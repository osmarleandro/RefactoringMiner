...
public class LocationInfo {
	...
	public List<String> getStringLiterals(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.stringLiterals;
	}
