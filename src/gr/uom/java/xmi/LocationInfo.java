...
public class LocationInfo {
	...
	public List<AnonymousClassDeclarationObject> getAnonymousClassDeclarations(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.anonymousClassDeclarations;
	}
