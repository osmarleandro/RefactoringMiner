...
public class LocationInfo {
	...
	public List<String> getPrefixExpressions(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.prefixExpressions;
	}
