...
public class LocationInfo {
	...
	public List<TernaryOperatorExpression> getTernaryOperatorExpressions(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.ternaryOperatorExpressions;
	}
