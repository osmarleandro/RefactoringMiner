...
public class LocationInfo {
	...
	public List<LambdaExpressionObject> getLambdas(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.lambdas;
	}
