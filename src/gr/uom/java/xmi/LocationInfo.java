...
public class LocationInfo {
	...
	public List<String> getPostfixExpressions(AnonymousClassDeclarationObject anonymousClassDeclarationObject) {
		return anonymousClassDeclarationObject.postfixExpressions;
	}
