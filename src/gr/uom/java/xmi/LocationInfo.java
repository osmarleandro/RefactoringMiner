...
public class LocationInfo {
	...
	public VariableDeclaration getVariableDeclaration(CompositeStatementObject compositeStatementObject, String variableName) {
		List<VariableDeclaration> variableDeclarations = compositeStatementObject.getAllVariableDeclarations();
