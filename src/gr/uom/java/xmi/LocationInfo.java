...
public class LocationInfo {
	...
	public VariableDeclaration getVariableDeclaration(StatementObject statementObject, String variableName) {
		List<VariableDeclaration> variableDeclarations = statementObject.getVariableDeclarations();
