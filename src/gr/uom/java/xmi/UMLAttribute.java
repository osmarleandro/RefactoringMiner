...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<UMLAttribute> getMergedAttributes(CandidateMergeVariableRefactoring candidateMergeVariableRefactoring) {
		return candidateMergeVariableRefactoring.mergedAttributes;
	}
}
