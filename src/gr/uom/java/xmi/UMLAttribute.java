...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<String> getMergedVariables(CandidateMergeVariableRefactoring candidateMergeVariableRefactoring) {
		return candidateMergeVariableRefactoring.mergedVariables;
	}
}
