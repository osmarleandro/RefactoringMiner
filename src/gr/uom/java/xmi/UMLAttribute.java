...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public String toString(ExtractClassRefactoring extractClassRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(extractClassRefactoring.getName()).append("\t");
		sb.append(extractClassRefactoring.extractedClass);
		sb.append(" from class ");
		sb.append(extractClassRefactoring.classDiff.getOriginalClass());
		return sb.toString();
	}
}
