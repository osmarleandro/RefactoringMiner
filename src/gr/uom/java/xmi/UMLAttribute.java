...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(ExtractClassRefactoring extractClassRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(extractClassRefactoring.getExtractedClass().getLocationInfo().getFilePath(), extractClassRefactoring.getExtractedClass().getName()));
		return pairs;
	}
}
