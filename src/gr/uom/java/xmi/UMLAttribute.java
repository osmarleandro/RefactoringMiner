...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public void setMergedAttributes(CandidateMergeVariableRefactoring candidateMergeVariableRefactoring, Set<UMLAttribute> mergedAttributes) {
		candidateMergeVariableRefactoring.mergedAttributes = mergedAttributes;
	}
}
