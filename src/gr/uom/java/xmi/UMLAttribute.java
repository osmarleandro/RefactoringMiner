...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider, IUMLAttribute {
	...
	public double normalizedNameDistance(IUMLAttribute attribute) {
