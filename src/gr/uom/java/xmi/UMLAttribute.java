...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public List<CodeRange> rightSide(ExtractAttributeRefactoring extractAttributeRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		ranges.add(codeRange()
				.setDescription("extracted attribute declaration")
				.setCodeElement(toString()));
		for(AbstractCodeMapping mapping : extractAttributeRefactoring.references) {
