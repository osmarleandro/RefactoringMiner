...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<UMLAttribute> getSplitAttributes(CandidateSplitVariableRefactoring candidateSplitVariableRefactoring) {
		return candidateSplitVariableRefactoring.splitAttributes;
	}
}
