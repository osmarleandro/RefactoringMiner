...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public List<CodeRange> leftSide(MoveAttributeRefactoring moveAttributeRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		ranges.add(moveAttributeRefactoring.originalAttribute.codeRange()
				.setDescription("original attribute declaration")
				.setCodeElement(moveAttributeRefactoring.originalAttribute.toString()));
		return ranges;
	}
}
