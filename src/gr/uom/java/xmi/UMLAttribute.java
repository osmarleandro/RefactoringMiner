...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(ExtractClassRefactoring extractClassRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(extractClassRefactoring.getOriginalClass().getLocationInfo().getFilePath(), extractClassRefactoring.getOriginalClass().getName()));
		return pairs;
	}
}
