...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesBeforeRefactoring(MoveAttributeRefactoring moveAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(moveAttributeRefactoring.getOriginalAttribute().getLocationInfo().getFilePath(), moveAttributeRefactoring.getOriginalAttribute().getClassName()));
		return pairs;
	}
}
