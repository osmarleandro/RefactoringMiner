...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public UMLOperation getOperationBefore(CandidateSplitVariableRefactoring candidateSplitVariableRefactoring) {
		return candidateSplitVariableRefactoring.operationBefore;
	}
}
