...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(MoveAttributeRefactoring moveAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(moveAttributeRefactoring.getMovedAttribute().getLocationInfo().getFilePath(), moveAttributeRefactoring.getMovedAttribute().getClassName()));
		return pairs;
	}
}
