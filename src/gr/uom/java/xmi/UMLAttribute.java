...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public String toString(ReplaceAttributeRefactoring replaceAttributeRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(replaceAttributeRefactoring.getName()).append("\t");
		sb.append(toQualifiedString());
		sb.append(" from class ");
		sb.append(replaceAttributeRefactoring.getSourceClassName());
		sb.append(" with ");
		sb.append(replaceAttributeRefactoring.movedAttribute.toQualifiedString());
		sb.append(" from class ");
		sb.append(replaceAttributeRefactoring.getTargetClassName());
		return sb.toString();
	}
}
