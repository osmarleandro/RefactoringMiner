...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public void setSplitAttributes(CandidateSplitVariableRefactoring candidateSplitVariableRefactoring, Set<UMLAttribute> splitAttributes) {
		candidateSplitVariableRefactoring.splitAttributes = splitAttributes;
	}
}
