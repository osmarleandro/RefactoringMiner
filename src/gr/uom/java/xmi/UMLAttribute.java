...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<String> getSplitVariables(CandidateSplitVariableRefactoring candidateSplitVariableRefactoring) {
		return candidateSplitVariableRefactoring.splitVariables;
	}
}
