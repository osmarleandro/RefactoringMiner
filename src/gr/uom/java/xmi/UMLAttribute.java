...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public UMLOperation getOperationAfter(CandidateSplitVariableRefactoring candidateSplitVariableRefactoring) {
		return candidateSplitVariableRefactoring.operationAfter;
	}
}
