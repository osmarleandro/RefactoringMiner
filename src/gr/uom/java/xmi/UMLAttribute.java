...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public boolean isEmpty(UMLAttributeDiff umlAttributeDiff) {
		return !umlAttributeDiff.visibilityChanged && !umlAttributeDiff.typeChanged && !umlAttributeDiff.renamed && !umlAttributeDiff.qualifiedTypeChanged && umlAttributeDiff.annotationListDiff.isEmpty();
	}
}
