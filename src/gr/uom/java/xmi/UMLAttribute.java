...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public UMLOperation getOperationBefore(CandidateMergeVariableRefactoring candidateMergeVariableRefactoring) {
		return candidateMergeVariableRefactoring.operationBefore;
	}
}
