...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<AbstractCodeMapping> getVariableReferences(CandidateMergeVariableRefactoring candidateMergeVariableRefactoring) {
		return candidateMergeVariableRefactoring.variableReferences;
	}
}
