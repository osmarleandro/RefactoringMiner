...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public boolean containsAttributeWithTheSameNameIgnoringChangedType(UMLAbstractClass umlAbstractClass) {
		for(UMLAttribute originalAttribute : umlAbstractClass.attributes) {
			if(originalAttribute.equalsIgnoringChangedType(this))
				return true;
		}
		return false;
	}
