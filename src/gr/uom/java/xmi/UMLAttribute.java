...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public List<CodeRange> rightSide(ExtractClassRefactoring extractClassRefactoring) {
		List<CodeRange> ranges = new ArrayList<CodeRange>();
		ranges.add(extractClassRefactoring.extractedClass.codeRange()
				.setDescription("extracted type declaration")
				.setCodeElement(extractClassRefactoring.extractedClass.getName()));
		return ranges;
	}
}
