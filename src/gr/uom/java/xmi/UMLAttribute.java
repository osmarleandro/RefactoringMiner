...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<AbstractCodeMapping> getVariableReferences(CandidateSplitVariableRefactoring candidateSplitVariableRefactoring) {
		return candidateSplitVariableRefactoring.variableReferences;
	}
}
