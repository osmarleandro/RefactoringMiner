...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public UMLOperation getOperationAfter(CandidateMergeVariableRefactoring candidateMergeVariableRefactoring) {
		return candidateMergeVariableRefactoring.operationAfter;
	}
}
