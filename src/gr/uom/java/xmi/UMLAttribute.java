...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public Set<ImmutablePair<String, String>> getInvolvedClassesAfterRefactoring(ExtractAttributeRefactoring extractAttributeRefactoring) {
		Set<ImmutablePair<String, String>> pairs = new LinkedHashSet<ImmutablePair<String, String>>();
		pairs.add(new ImmutablePair<String, String>(extractAttributeRefactoring.getNextClass().getLocationInfo().getFilePath(), extractAttributeRefactoring.getNextClass().getName()));
		return pairs;
	}
}
