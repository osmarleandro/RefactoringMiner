...
public class UMLAttribute implements Comparable<UMLAttribute>, Serializable, LocationInfoProvider, VariableDeclarationProvider {
	...
	public String toString(MoveAndRenameAttributeRefactoring moveAndRenameAttributeRefactoring) {
		StringBuilder sb = new StringBuilder();
		sb.append(moveAndRenameAttributeRefactoring.getName()).append("\t");
		sb.append(toQualifiedString());
		sb.append(" renamed to ");
		sb.append(moveAndRenameAttributeRefactoring.movedAttribute.toQualifiedString());
		sb.append(" and moved from class ");
		sb.append(moveAndRenameAttributeRefactoring.getSourceClassName());
		sb.append(" to class ");
		sb.append(moveAndRenameAttributeRefactoring.getTargetClassName());
		return sb.toString();
	}
}
