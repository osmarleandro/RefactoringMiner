...
public class RefFinderResultReader {
    ...
    private static Map<String, Function<List<String>, RefactoringRelationship>> initMappings() {
        ...
        mappers.put("rename_method", args -> parse(args, RefactoringType.RENAME_METHOD, member_RENAMED(1), member_RENAMED(2)));
        ...
        mappers.put("extract_method", args -> parse(args, RefactoringType.EXTRACT_OPERATION, member_RENAMED(1), member_RENAMED(2)));
        mappers.put("inline_method", args -> parse(args, RefactoringType.INLINE_OPERATION, member_RENAMED(2), member_RENAMED(1)));
    ...
    private static EntityParser member_RENAMED(final int i) {
        return new EntityParser() {
            @Override
            String parse(List<String> args) {
                return normalize(args.get(i - 1));
