...
public class RefactoringPopulator {
	...
	public static void feedRefactoringsInstances(BigInteger refactoringsFlag, int systemsFlag, ITestBuilder test)
	...
	private static void prepareFSERefactorings(ITestBuilder test, BigInteger flag)
			throws JsonParseException, JsonMappingException, IOException {
