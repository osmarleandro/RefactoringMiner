...
public class RefactoringPopulator {
	...
	public static void feedRefactoringsInstances(BigInteger refactoringsFlag, int systemsFlag, TestBuilder_RENAMED test)
	...
	private static void prepareFSERefactorings(TestBuilder_RENAMED test, BigInteger flag)
			throws JsonParseException, JsonMappingException, IOException {
